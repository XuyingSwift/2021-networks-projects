...
class Host:
    ...
    def udt_send(self, dst_addr, data_S, mtuMAX):
        # create two packets if the data_S is longer than mtuMax
        if len(data_S) > mtuMAX:
            # we cut the data_s into two parts in the middle
